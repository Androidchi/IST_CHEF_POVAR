...
import kotlinx.android.synthetic.main.proccesing_itemadapter.view.btnCart
...
class OrderFoodsAdapter(val list:List<OrderFoodModel>, val handler: OrderFoodsAdapterListener):BaseAdapter(list.toMutableList(), R.layout.proccesing_itemadapter) {
