...
class ProductFoodsAdapter(items:List<ProductModel>,hanler:BaseAdapterListener) : BaseAdapter(items.toMutableList(),R.layout.product_foods_adapter,hanler) {
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        ...
        holder.itemView.tvProductPrice.text =item.price.formattedAmount()
        ...
        holder.itemView.tvStatus.text=holder.itemView.context.getString(R.string.completed)
            ...
            holder.itemView.cardViewStatus.setCardBackgroundColor(holder.itemView.context.getColor(R.color.yellow))
        }
