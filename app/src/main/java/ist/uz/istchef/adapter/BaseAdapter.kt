...
abstract class BaseAdapter(var items: MutableList<Any?>, val layout: Int,
    val listener: BaseAdapterListener? = null) : RecyclerView.Adapter<BaseAdapter.ItemHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseAdapter.ItemHolder {
